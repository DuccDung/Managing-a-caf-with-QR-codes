...
namespace WebQuanLyNhaHang.Controllers
{
    public class DonHangsController : Controller
    {
        ...
        public DonHangsController(QlnhaHangBtlContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DhId,KhId,BanId,KmId,GioVao,GioRa,GhiChu,TongTien,NvId,TrangThai,VanChuyen")] DonHang donHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DhId,KhId,BanId,KmId,GioVao,GioRa,GhiChu,TongTien,NvId,TrangThai,VanChuyen")] DonHang donHang)
        {
            if (id != donHang.DhId)
            {
                return NotFound();
